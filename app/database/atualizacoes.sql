...
--19/05/2022
create table cad_product_category(
  id SERIAL       PRIMARY KEY       NOT NULL,
  dt_register     TIMESTAMP         NOT NULL,
  name            TEXT              NOT NULL
);

ALTER TABLE cad_product_category OWNER TO sync;
GRANT SELECT, UPDATE, INSERT, DELETE ON cad_product_category TO sync;
...
create table cad_product(
  ...
  FOREIGN KEY (category_id)   REFERENCES cad_product_category (id),
  FOREIGN KEY (user_id)       REFERENCES sys_user (id)
);

ALTER TABLE cad_product OWNER TO sync;
GRANT SELECT, UPDATE, INSERT, DELETE ON cad_product TO sync;